    ...
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 w-full z-50 px-4 py-4 md:px-12 md:py-6 flex justify-between items-center bg-white/80 backdrop-blur-sm">
        <Link href="/" className="block">
          <div className="w-12 h-12 custom-circle flex items-center justify-center">
            <span className="text-custom-dark text-xl font-bold">A</span>
          </div>
        </Link>
      ...
      <section className="relative pt-32 pb-64 md:pt-40 md:pb-80 px-6 md:px-12 overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            {/*fungsi t() untuk terjemahan*/}
            {t("A collection of my projects in software engineering, game development, web, Unity, Unreal, and AI. Feel free to explore.",
            )}
          </motion.p>
        </div>
      ...
      <section id="work" className="py-24 md:py-32 bg-custom-dark">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div>
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-4">
                LMS Bicimici Platform
              </h3>

              <p className="text-lg mb-6 text-white">
                {t("A web-based Learning Management System designed for cybersecurity education. Integrated with interactive Unity WebGL games to enhance engagement and learning experience.")}
              </p>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="order-2 md:order-1">
              <h3 className="text-4xl md:text-5xl font-bold text-custom-dark mb-4">
                Bicimici Educational Game
              </h3>

              <p className="text-lg mb-6 text-custom-dark">
                {t("An interactive 2D educational game focused on cybersecurity awareness for children. Covers real-life digital risks through engaging storytelling and scenario-based gameplay.")}
              </p>
        ...
        >
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div>
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-4">Ecochat Website chat AI 3D</h3>
              <p className="text-lg mb-6 text-white">
                {t("Development of a responsive website with integrated AI chat assistant to enhance user interaction and provide instant support. Designed with a focus on sustainability and smart communication.")}
              </p>

              <div className="space-y-2 mb-8 text-white">
                <p className="text-sm">
                  <span className="font-bold">{t("Project type:")}</span> {t("AI Chat Website")}
                </p>
                <p className="text-sm">
                  <span className="font-bold">{t("Role:")}</span> {t("Fullstack Web Developer")}
                </p>
                <p className="text-sm">
        ...
        >
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-4xl md:text-5xl font-bold text-custom-dark mb-4">Dashboard Report Soul Parking</h3>
              <p className="text-lg mb-6 text-custom-dark">
                {t("A web-based dashboard designed to monitor and analyze parking issues across multiple locations. The system provides real-time reporting, automatic notifications, and performance insights for each site.")}
              </p>
              ...
              <div className="space-y-2 mb-8 text-custom-dark">
                ...
                <p className="text-sm">
                  <span className="font-bold">{t("Role:")}</span> {t("Frontend Developer")}
                </p>
                <p className="text-sm">
                  <span className="font-bold">{t("Industry:")}</span> {t("Smart Parking, IoT")}
                </p>
              </div>
              ...
              <div className="space-y-8 text-white">
                <div>
                  <h4 className="text-xl font-bold">
                    {t("Game technology atau Web development")}
                  </h4>
                  <p className="text-lg font-medium">
                    {t("National Cyber and Crypto Agency • Nov 2025 - May 2026")}
                  </p>
                  <p className="mt-2">
                    {t("Developed an LMS and cybersecurity educational games for elementary to high school students.")}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg font-medium">
                    {t("PT. Kreasi Kode Biner • Sep 2021 - Nov 2025")}
                  </p>
                  <p className="mt-2">
